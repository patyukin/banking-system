...
func (c *authV1Client) SignIn(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (UnimplementedAuthV1Server) SignIn(context.Context, *AuthRequest) (*AuthResponse, error) {
...
func _AuthV1_SignIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthV1Server).SignIn(ctx, req.(*AuthRequest))
	}
